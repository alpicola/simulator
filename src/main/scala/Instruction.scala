...
object Instruction {
  ...
  case class Lwx(rd:Int, rs:Reg, rt:Reg) extends Instruction with R  { val shamt = 0; val funct = 46 }
  case class Swx(rd:Int, rs:Reg, rt:Reg) extends Instruction with R  { val shamt = 0; val funct = 47 }
  ...
  case class Break() extends Instruction with I { val op = 31; val rt = 0; val rs = 0; val imm = 0 }
  ...
  case class Fmove(rd:Reg, rs:Reg) extends Instruction with F  { val rt = 0; val funct = 4 }
  ...
  case class Dump(rs:Reg) extends Instruction with IO  { val rt = 0; val rd = 0; val funct = 11 }
  case class Dumpf(rs:Reg) extends Instruction with IO { val rt = 0; val rd = 0; val funct = 25 }
}
